...
export function createRecord<T>(model: string, path: string, data: any = {},
                                params: object = {}, opts: Opts = {}
                               ): CrudAction<T> {
  const fetchConfig = opts.fetchConfig || undefined
...
export function updateRecord<T>(model: string, id: ID, path: string, data: any = {},
                                params: object = {}, opts: Opts = {}
                               ): CrudAction<T> {
  const fetchConfig = opts.fetchConfig || undefined;
...
export function apiCall<T>(success: string, failure: string, method: Method, path: string,
                           params: object = {}, data: any = undefined, opts: any = {}
                          ): CrudAction<T> {
